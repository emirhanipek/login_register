...
<?php
    // URL'deki hata parametresine göre mesajı göster
    if (isset($_GET['error'])) {
        if ($_GET['error'] == 'wrongpassword') {
            echo '<div class="alert alert-danger text-center p-2 m-0" role="alert">
  Oops! Hatalı Şifre !!
</div>';
        } elseif ($_GET['error'] == 'wrongemail') {
            echo '<div class="alert alert-danger text-center p-2 m-0" role="alert">
  Oops! Hatalı Mail Adresi !!
</div>';
        }
    }
    ?>
                ...
                <div class="grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 gap-6">
                    ...
                    <div class="xl:col-span-2 lg:col-span-1">
                        <div class="bg-sky-600 text-white gap-10 h-full w-full p-7 space-y-6 lg:space-y-0">
                            ...
                            <div class="flex flex-col justify-center text-center h-full">
                                ...
                                <p class="text-gray-200 font-normal leading-relaxed">Kişisel bilgilerinizi girin ve bizimle yolculuğa başlayın</p>
                                <div class="my-8">
                                    <a href="signup-2.php" class="border text-white font-medium text-sm rounded-full transition-all duration-300 hover:bg-white hover:text-black focus:bg-white focus:text-black px-14 py-2.5">Kayıt Ol</a>
                                </div>
                            </div>
                    ...
                    <div class="xl:col-span-3 lg:col-span-2 lg:m-10 m-5">
                        <div class="text-center">
                            <div>
                                <h1 class="text-3xl/tight text-sky-600 mb-3">Giriş Yap Sergio Ferrari</h1>
                                ...
                                <p class="text-sm font-medium leading-relaxed">Veya e-posta hesabınızı kullanın</p>
                            </div>
                            <form action="../../controller/userController/usercontroller.php?operation=login" method="POST">
                            <div class="space-y-5 mt-10">
                                ...
                                <a href="forgot-password-2.php" class="text-gray-500 font-medium underline block">Şifreni Mi Unuttun?</a>
                            </div>

                            <div class="mt-8">
                                <button class="bg-sky-600 text-white font-medium text-sm rounded-full px-14 py-3">Giriş Yap</button>
                            </div>
                            </form>

...
<body>
    ...
    <section class="h-screen flex items-center justify-center bg-no-repeat bg-opacity-50 inset-0 bg-cover bg-[url('../images/bg-2.png')]">
                ...
                <div class="grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 gap-6">
                    ...
                    <div class="xl:col-span-2 lg:col-span-1">
                        <div class="bg-sky-600 text-white gap-10 h-full w-full p-7 space-y-6 lg:space-y-0">
                            ...
                            <div class="flex flex-col justify-center text-center h-full">
                                <h1 class="text-3xl/tight mb-4">Sizi Gördüğüme Sevindim</h1>
                    ...
                    <div class="xl:col-span-3 lg:col-span-2 lg:m-10 m-5">
                        <div class="text-center">
                            <div>
                                <h1 class="text-3xl/tight text-sky-600 mb-3">Şifremi Unuttun</h1>
                                ...
                                <p class="text-sm font-medium leading-relaxed">E-postanızı girin, şifrenizi sıfırlamanız için size bir bağlantı göndereceğiz.</p>
                            </div>
                            <form action="../../controller/userController/usercontroller.php?operation=reset_password" method="POST">
                            ...
                            <div class="mt-8">
                                <button name="reset_password" class="bg-sky-600 text-white font-medium text-sm rounded-full px-14 py-3">Gönder</button>
                            </div>
                            </form>
                        </div>
                    </div>
